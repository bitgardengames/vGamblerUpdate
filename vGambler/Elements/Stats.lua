...
function vGambler:SetupDashboardHeader(page)
	...
	Report:SetBackdropColor(0.184, 0.192, 0.211)
	Report:SetBackdropBorderColor(0.184, 0.192, 0.211)
	...
	Report.Label:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
...
function vGambler:AddLongStatLine(parent)
	...
	Line.Name:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	Line.Wins:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	Line.WinPercent:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))

	Line.Earnings = Line:CreateFontString(nil, "OVERLAY")
	Line.Earnings:SetPoint("RIGHT", Line, -5, -0.5)
	Line.Earnings:SetJustifyH("RIGHT")
	Line.Earnings:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
...
function vGambler:SetupStatsPage(page)
	...
	Player.Label:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	Wins.Label:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	WinPercent.Label:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	Earnings.Label:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
