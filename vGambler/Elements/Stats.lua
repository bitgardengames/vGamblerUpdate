...
function vGambler:SetupStatsPage(page)
	...
	local Player = CreateFrame("Frame", nil, StatArea.Header, "BackdropTemplate")
	Player:SetSize(111, 24)
	Player:SetPoint("LEFT", StatArea.Header, 0, 0)
	Player:SetBackdrop(self.SmallBackdrop)
	Player:SetBackdropColor(0.184, 0.192, 0.211)
	Player:SetBackdropBorderColor(0.184, 0.192, 0.211)
	Player.SortMode = "Name"
	Player:SetScript("OnMouseUp", self.OnStatCategoryMouseUp)
	Player:SetScript("OnEnter", self.WindowButtonOnEnter)
	Player:SetScript("OnLeave", self.WindowButtonOnLeave)
	...
	local Wins = CreateFrame("Frame", nil, StatArea.Header, "BackdropTemplate")
	Wins:SetSize(67, 24)
	Wins:SetPoint("LEFT", Player, "RIGHT", 4, 0)
	Wins:SetBackdrop(self.SmallBackdrop)
	Wins:SetBackdropColor(0.184, 0.192, 0.211)
	Wins:SetBackdropBorderColor(0.184, 0.192, 0.211)
	Wins.SortMode = "Wins"
	Wins:SetScript("OnMouseUp", self.OnStatCategoryMouseUp)
	Wins:SetScript("OnEnter", self.WindowButtonOnEnter)
	Wins:SetScript("OnLeave", self.WindowButtonOnLeave)
	...
	local WinPercent = CreateFrame("Frame", nil, StatArea.Header, "BackdropTemplate")
	WinPercent:SetSize(87, 24)
	WinPercent:SetPoint("LEFT", Wins, "RIGHT", 4, 0)
	WinPercent:SetBackdrop(self.SmallBackdrop)
	WinPercent:SetBackdropColor(0.184, 0.192, 0.211)
	WinPercent:SetBackdropBorderColor(0.184, 0.192, 0.211)
	WinPercent.SortMode = "WinPercent"
	WinPercent:SetScript("OnMouseUp", self.OnStatCategoryMouseUp)
	WinPercent:SetScript("OnEnter", self.WindowButtonOnEnter)
	WinPercent:SetScript("OnLeave", self.WindowButtonOnLeave)
	...
	local Earnings = CreateFrame("Frame", nil, StatArea.Header, "BackdropTemplate")
	Earnings:SetSize(68, 24)
	Earnings:SetPoint("LEFT", WinPercent, "RIGHT", 4, 0)
	Earnings:SetBackdrop(self.SmallBackdrop)
	Earnings:SetBackdropColor(0.184, 0.192, 0.211)
	Earnings:SetBackdropBorderColor(0.184, 0.192, 0.211)
	Earnings.SortMode = "Earnings"
	Earnings:SetScript("OnMouseUp", self.OnStatCategoryMouseUp)
	Earnings:SetScript("OnEnter", self.WindowButtonOnEnter)
	Earnings:SetScript("OnLeave", self.WindowButtonOnLeave)
