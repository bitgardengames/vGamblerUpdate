...
function vGambler:SetupDashboardHeader(page)
	...
	Report.Label:SetShadowOffset(1, -1)
...
function vGambler:AddLongStatLine(parent)
	...
	Line.WinPercent:SetShadowOffset(1, -1)
	...
	Line.Earnings:SetShadowOffset(1, -1)
...
function vGambler:SetupStatsPage(page)
	...
	Wins.Label:SetShadowOffset(1, -1)
	...
	WinPercent.Label:SetShadowOffset(1, -1)
	...
	Earnings.Label:SetShadowOffset(1, -1)
