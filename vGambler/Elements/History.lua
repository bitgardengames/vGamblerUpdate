...
function vGambler:SetupHistoryPage(page)
	...
	Header.Loser:SetShadowOffset(1, -1)
	...
	Header.Value:SetShadowOffset(1, -1)
	...
	Header.Date:SetShadowOffset(1, -1)
	...
	for i = 1, 12 do
		...
		Line.Winner:SetShadowOffset(1, -1)
		...
		Line.Loser:SetShadowOffset(1, -1)
		...
		Line.Value:SetShadowOffset(1, -1)
