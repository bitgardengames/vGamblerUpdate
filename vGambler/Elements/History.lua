...
function vGambler:SetupHistoryPage(page)
	...
	Header.Loser:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	Header.Value:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	Header.Date:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	for i = 1, 12 do
		...
		Line.Winner:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
		...
		Line.Loser:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
		...
		Line.Value:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
		...
		Line.Date:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
