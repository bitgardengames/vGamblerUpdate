...
function vGambler:AddStatLine(t, parent, id)
	...
	Line.Left:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))

	Line.Right = Line:CreateFontString(nil, "OVERLAY")
	Line.Right:SetPoint("RIGHT", Line, -5, -0.5)
	Line.Right:SetJustifyH("RIGHT")
	Line.Right:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
