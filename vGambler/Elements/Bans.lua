...
function vGambler:AddBannedPlayerUI(name, reason)
	...
	elseif self.FreeBannedPlayers[1] then
		...
		self:SetFont(Bar.Label, self.Font, self.Settings.FontSize)
		Bar.Label:SetJustifyH("LEFT")
		Bar.Label:SetSize(94, 12)

		Bar.Reason = Bar:CreateFontString(nil, "OVERLAY")
		Bar.Reason:SetPoint("LEFT", Bar, "CENTER", -60, -1)
		self:SetFont(Bar.Reason, self.Font, self.Settings.FontSize)
...
function vGambler:SetupBansPage(page)
	...
	self:SetFont(NameInput, self.Font, self.Settings.FontSize)
	...
	self:SetFont(ReasonInput, self.Font, self.Settings.FontSize)
	...
	self:SetFont(BanButton.Label, self.Font, self.Settings.FontSize)
	...
	self:SetFont(BanArea.HeaderLabel, self.Font, self.Settings.FontSize)
	...
	self:SetFont(BanArea.HeaderReason, self.Font, self.Settings.FontSize)
