...
function vGambler:SetupBansPage(page)
	...
	NameInput:SetBackdropColor(0.184, 0.192, 0.211)
	NameInput:SetBackdropBorderColor(0.184, 0.192, 0.211)
	...
	NameInput:SetScript("OnLeave", self.WindowButtonOnLeave)
	...
	ReasonInput:SetBackdropColor(0.184, 0.192, 0.211)
	ReasonInput:SetBackdropBorderColor(0.184, 0.192, 0.211)
	...
	ReasonInput:SetScript("OnLeave", self.WindowButtonOnLeave)
