...
function vGambler:AddBannedPlayerUI(name, reason)
	...
	elseif self.FreeBannedPlayers[1] then
		...
		Bar.Label:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
		Bar.Label:SetJustifyH("LEFT")
		Bar.Label:SetSize(94, 12)

		Bar.Reason = Bar:CreateFontString(nil, "OVERLAY")
		Bar.Reason:SetPoint("LEFT", Bar, "CENTER", -60, -1)
		Bar.Reason:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
...
function vGambler:SetupBansPage(page)
	...
	NameInput:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	ReasonInput:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	BanButton.Label:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	BanArea.HeaderLabel:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	BanArea.HeaderReason:SetFontObject(self:GetFontObject(self.Font, self.Settings.FontSize))
	...
	BanScroll:SetThumbTexture("Interface\\AddOns\\vGambler\\Assets\\HydraRoundThumb.tga")
