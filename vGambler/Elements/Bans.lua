...
function vGambler:AddBannedPlayerUI(name, reason)
	...
	elseif self.FreeBannedPlayers[1] then
		...
		Bar.Reason:SetShadowOffset(1, -1)
...
function vGambler:SetupBansPage(page)
	...
	ReasonInput:SetShadowOffset(1, -1)
	...
	BanButton.Label:SetShadowOffset(1, -1)
	...
	BanArea.HeaderLabel:SetShadowOffset(1, -1)
	...
	BanArea.HeaderReason:SetShadowOffset(1, -1)
