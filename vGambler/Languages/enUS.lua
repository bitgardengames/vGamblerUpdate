...
L.MATCH_SUMMARY = "Winner: %s  Loser: %s  Value: %s|cffffe02eg|r"
...
L.PAIRWISE_LEDGER = "Pairwise Ledger (All Time)"
L.WON_FROM = "Won from"
L.LOST_TO = "Lost to"
L.NET_BALANCE = "Net balance:"
L.NO_PAIRWISE_BALANCES = "No pairwise results recorded yet."
