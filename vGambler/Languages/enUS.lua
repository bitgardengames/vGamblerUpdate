...
L.ALL_TIME_STATS = "All-time stats"
L.STATS_REPORT_HEADER = L.PREFIX .. ": %s by earnings"
L.STATS_REPORT_ENTRY = "%d. %s: %s%s gold"
L.NO_STATS_TO_REPORT = L.PREFIX .. ": No player stats to report."
